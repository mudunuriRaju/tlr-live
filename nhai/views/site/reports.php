                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand navbar-brand-custom" href="#"><img
                                src="<?php echo Yii::$app->request->baseUrl; ?>/images/logo.png" width="119" height="61"
                                alt=""/></a>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 p0 tr">
            ...
            <div class="login-user-text disinblo">
                <div align="left">Subba Raju</div>
                <div align="left"><a href="#">Logout</a></div>
            </div>
        </div>
            ...
            <div class="rightPanBox">
                <div class="header2">
                    <div class="col-lg-3 col-md-3 col-sm-3 hidden-xs">
                        <div style="margin:26px 0 0 0; font-family:OMUPro-Light; color:#FFFFFF;">
                            <div style="font-size:40px;">1245</div>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" align="right">
                        <form>
                            ...
                            <div id="direction" style="display:none">
                                ...
                                <div>
                                    <button class="point-point-but">Find</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="content-area">
                    <div class="pad-left-right" align="right">
                        ...
                        <span>
                            	<a href="#"><img src="<?php echo Yii::$app->request->baseUrl; ?>/images/excel.png"
                    ...
                    <div align="center">
                        <table width="96%" border="0" cellspacing="0" class="content-table">
                            ...
                            <?php foreach ($history as $value) { ?>
                                <tr class="date-row">
                                    <td rowspan="2"
                                        class="border-dark"><?php echo date('d/m/Y', strtotime($value->date)) ?></td>
                        ...
                        <div align="right" class="pad-left-right">Average Daily collection from 1st Mar to till date is
                            - <strong>1,43,245</strong></div>
