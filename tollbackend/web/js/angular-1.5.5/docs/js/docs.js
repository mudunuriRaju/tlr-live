...
angular.module('tutorials', [])
    ...
    .directive('docTutorialNav', function () {
        ...
        return {
            scope: {},
            template: '<a ng-href="tutorial/{{prev}}"><li class="btn btn-primary"><i class="glyphicon glyphicon-step-backward"></i> Previous</li></a>\n' +
    ...
    .directive('docTutorialReset', function () {
        return {
            ...
            template: '<p><button class="btn" ng-click="show=!show">Workspace Reset Instructions  ➤</button></p>\n' +
