...
<div class="toll-booths-index">
    ...
    <p>
        <?php if (Yii::$app->user->identity->toll_user_type_id == 1) { ?><?= Html::a('Create Toll Booths', ['create'], ['class' => 'btn btn-success']) ?><?php } ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'template' => (Yii::$app->user->identity->toll_user_type_id == 3 || Yii::$app->user->identity->toll_user_type_id == 2) ? '{view}{link}' : '{view} {delete}{link}',
            ],
        ],
    ]); ?>
