...
class TollForm extends Tolls
{
    ...
    public $language_id;
    public $toll_unique_number, $toll_location, $toll_lat, $toll_lng, $toll_radius, $allowed_ip;

    public function rules()
    {
        return [
            [['toll_unique_number', 'toll_location', 'toll_lat', 'toll_lng', 'toll_radius', 'toll_employee_id', 'toll_password', 'toll_id', 'toll_user_type_id', 'language_id'], 'required'],
