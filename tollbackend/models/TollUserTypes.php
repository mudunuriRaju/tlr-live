...
/**
 * TollUserTypes represents the model behind the search form about `backend\models\MasterTollUserTypes`.
 */
class TollUserTypes extends MasterTollUserTypes
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = MasterTollUserTypes::find();
