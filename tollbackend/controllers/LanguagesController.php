...
class LanguagesController extends Controller
{
    ...
    /**
     * Creates a new MasterLanguage model.
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->lagunage_id]);
        } else {
    ...
    /**
     * Updates an existing MasterLanguage model.
    ...
    {
        if (($model = MasterLanguage::findOne($id)) !== null) {
            return $model;
        } else {
