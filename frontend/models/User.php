...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['firstname', 'lastname', 'user_email', 'password', 'password_hash', 'mobile_number'], 'required'],
            [['created_on', 'language_id', 'language_name', 'language.laguage_name', 'profile_pic', 'otp', 'address'], 'safe'],
            [['user_email'], 'unique', 'on' => 'create'],
            [['amount'], 'number'],
    ...
    public function fields()
    {
        ...
        unset($fields['auth_key'], $fields['password_hash'], $fields['reset_code'], $fields['password'], $fields['amount'], $fields['status'], $fields['expiry_date'], $fields['created_on']);
